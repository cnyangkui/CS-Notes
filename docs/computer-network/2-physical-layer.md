...
* [2.1 数据通信](#2.1-数据通信)
  * [2.1.1 通信方式](#2.1.1-通信方式)
  * [2.1.2 基带调制/编码](#2.1.2-基带调制/编码)
  * [2.1.3 带通调制](#2.1.3-带通调制)
  * [2.1.4 信道的极限容量](#2.1.4-信道的极限容量)
* [2.2 信道复用技术](#2.2-信道复用技术)
  * [2.2.1 频分复用](#2.2.1-频分复用)
  * [2.2.2 时分复用](#2.2.2-时分复用)
  * [2.2.3 统计时分复用](#2.2.3-统计时分复用)
  * [2.2.4 波分复用](#2.2.4-波分复用)
  * [2.2.5 码分复用](#2.2.5-码分复用)
