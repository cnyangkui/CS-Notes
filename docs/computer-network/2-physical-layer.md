...
(1) **信道能够通过的频率范围**是有限的。在任何信道中，码元传输的速率是有上限的，传输速率超过此上线就会出现码间串扰问题（信号中的高频分量在传输时会收到衰减，接收端接受的信号波形失去了码元之间的清晰界限），使得接收端对码元的判决成为不可能。
...
<div align="center"> <img src="images/2-8.png" width="120"> </div>
