...
<h3 id="3.3.3">3.3.3 以太网的 MAC 层</h3>

<h4 id="3.3.3.1">1. 硬件地址</h4>

又称为**物理地址**或**MAC地址**。IEEE 802 标准为局域网规定了一种48位全球地址，是指局域网上的每一台计算机中**固化在适配器的 ROM 中的地址**。

<h4 id="3.3.3.2">2. MAC 帧的格式</h4>

<div align="center"> <img src="images/3-12.png" width="400"></div>
